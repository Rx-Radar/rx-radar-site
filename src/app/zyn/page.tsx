...
export default async function zynRadar() {
    // const res = await fetch(`https://localhost:3000/api/zyn-get-store`, { cache: 'no-store' }); // dev
    const res = await fetch(`https://rx-radar.com/api/zyn-get-store`, { cache: 'no-store' }); // production
