                ...
                <div className={styles.searchResultContainer}>
                    { filteredResults.map((result, index) => {
                        ...
                        if (result == selectedItem) {
                            return <div key={index} className={styles.searchResultItem} style={{border: '2px solid #F94D00', display: 'flex', justifyContent: 'space-between'}}>
                            ...
                            return <div key={index}  className={styles.searchResultItem}>
                                <p style={{color: 'black'}}>{result}</p>
                            </div>
                        }
                    })}
