...
interface PrescriptionSearchFormProps {
    ...
    initializeMedicationSearch: () => void; // function called on option input changed
}
        ...
        <div className={styles.prescription_search_form}>
            ...
            <div className={styles.medication_options}>
              <div className={styles.option_input_pair}>
                <OptionInput style={{width: '100%'}} onChange={(option) => setDosage(option)} name='Dosage' options={['10mg', '20mg', '30mg', '40mg', '80mg', '100mg', '120mg']}/>
                <OptionInput style={{width: '100%'}} onChange={(option) => setBrand(option)} name='Brand/Generic' options={['Brand', 'Generic', 'Either']}/>
              </div>
              <div className={styles.option_input_pair}>
                <OptionInput style={{width: '100%'}} onChange={(option) => setQuantity(option)} name='Quantity' options={['30', '60', '80', '100']}/>
                <OptionInput style={{width: '100%'}} onChange={(option) => setType(option)} name='Type' options={['IR', 'XR', 'none']}/>
              </div>
            </div>
